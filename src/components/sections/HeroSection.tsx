...
function HeroSection({
  ...
  const checkIn = [
    {
      value: "Sun, 17th Sep 2024",
      displayName: "Sun, 17th Sep 2024",
    },
    {
      value: "Sun, 18th Sep 2024",
      displayName: "Sun, 18th Sep 2024",
    },
  ];

  const checkOut = [
    {
      value: "Sun, 17th Oct 2024",
      displayName: "Sun, 17th Oct 2024",
    },
    {
      value: "Sun, 18th Oct 2024",
      displayName: "Sun, 18th Oct 2024",
    },
  ];
  ...
  return (
    <section className="relative mb-16">
      <div className="pt-[100px] md:pt-16">
        <p
          className={cn(
            "text-[40px] md:text-[84px] font-semibold text-[#1b250f] leading-tight",
            "mx-8 xl:mx-[184px]"
          )}
        >
          Start Your Unforgettable <br /> Journey With Us.
        </p>
        <p className="text-24 text-yellow-400 font-normal mt-3 mx-8 xl:mx-[184px]">
          The best travel for your jouney begins now
        </p>
      </div>

      <div className="flex flex-col md:flex-row mt-8 md:mt-[170px] mx-4 md:mx-0">
        <div className="bg-secondary py-16 flex flex-col rounded-t-[16px] md:rounded-t-none md:flex-row gap-[40px] px-4 md:px-32">
          <div>
            <p className="text-customGray mb-4">Destination</p>
            <Select>
              <SelectTrigger className="w-full border-t-0 border-x-0 border-b border-b-black rounded-none bg-transparent">
        ...
        <div className="bg-primary flex items-center justify-between py-16 gap-[40px] px-4 md:px-[20px] rounded-b-[20px] md:rounded-bl-none md:rounded-r-[20px]">
          <div className={cn("text-white flex gap-2 md:gap-0 md:block")}>
